...
Свёрстанная страница без ошибок в разметке, именовании и оформлении кода, внешний вид которой можно посмотреть по ссылке: [внешний вид готовой страницы](resourses/ready-page.jpg).
